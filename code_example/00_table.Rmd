...
https://cran.r-project.org/web/packages/kableExtra/vignettes/awesome_table_in_html.html#Basic_HTML_table
...
tribble(
  ...
  "지각 유", "진양성", "위양성",
  "지각 무",  "위음성", "진음성" ) %>% 
  kbl(booktabs = T, caption = "존재와 인식의 4개 유형") %>% 
  kable_classic() 
...
```{r ascii, echo=FALSE, message=FALSE, warning=FALSE}
library(kableExtra)
knitr::kable(
tribble(
  ~종류, ~아스키코드, ~문자, ~비고, 
