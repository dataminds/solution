...
## 기존 논의
### 해결지향보도의 범위
#### 사회현상에 대한 적절한 반영(수동적 반영인가, 능동적 개입인가)
#### 사회현상에 대한 능동적 개입
### 솔루션저널리즘네트워크의 접근
#### 정의
#### 솔루션저널리즘의 4대 기둥
#### 해법저널리즘이 아닌 것(McIntyer & Lough, 2017; SJN이규원, 2021).
...
#### 사전분석(dictionary analysis)
### 반지도학습(semisupervised learing)
### 절차
## 품질측정2: 자연어 생성
